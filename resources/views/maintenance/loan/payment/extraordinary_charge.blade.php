                ...
                <div class="row">
                    ...
                    <div class="col">
                        @component('layouts.components.form-group', [
                            ...
                            'align' => 'right',
                            'format' => 'number',
                            'label' => 'Interés Pendiente RD$',
                            'name' => 'interest_rd',
                            'readonly' => true,
                            'value' => $loan->pre_interp,
                        ]) @endcomponent
                    </div>
                    <div class="col">
                        @component('layouts.components.form-group', [
                            ...
                            'align' => 'right',
                            'format' => 'number',
                            'label' => 'Balance Capital RD$',
                            'name' => 'quota_rd',
                            'readonly' => true,
                            'value' => $loan->pre_capitp,
                        ]) @endcomponent
                    </div>
                    <div class="col">
                        @component('layouts.components.form-group', [
                            ...
                            'align' => 'right',
                            'format' => 'number',
                            'label' => 'Capital Vencido RD$',
                            'name' => 'capital_defeated_rd',
                            'readonly' => true,
                            'value' => $loan->pre_capitp,
                        ]) @endcomponent
                    </div>
                    <div class="col">
                        @component('layouts.components.form-group', [
                            ...
                            'align' => 'right',
                            'format' => 'number',
                            'label' => 'Interés Vencido RD$',
                            'name' => 'interest_defeated_rd',
                            'readonly' => true,
                            'value' => $loan->pre_interp,
                        ]) @endcomponent
                    </div>
